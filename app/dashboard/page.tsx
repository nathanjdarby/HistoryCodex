...
export default function DashboardPage() {
  const { data: auth } = useQuery({
    queryKey: ["auth", "me"],
    queryFn: () => fetchJson<{ user: { firstName?: string | null } | null }>("/api/auth/me"),
  });
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        description="Pick up where you left off — continue reading, log history, and grow your collection."
        icon={Landmark}
        actions={
          <Link href="/profile" className="app-btn-secondary text-sm">
            View profile
          </Link>
        }
      />
