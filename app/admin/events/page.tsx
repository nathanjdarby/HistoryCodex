...
export default function AdminEventsPage() {
  ...
  const eventRows = useMemo(
    () => (characters ?? []).filter((c) => c.cardType === "event"),
    [characters],
  );
  ...
  }, [eventRows, searchQuery, regionFilter, eraFilter, rarityFilter, ownedFilter, imageFilter, sortKey, sortDir]);
