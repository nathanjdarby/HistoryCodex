...
> = {
  ...
  epidemic: {
    summary: "Deal damage to every unit in the chosen lane.",
    eventTemplate: "Plague Outbreak",
    contexts: ["event"],
    triggers: [],
    valueKind: "number",
    valueGuide: "Damage dealt to each unit in the lane (typically 10–30).",
    needsLane: true,
  },
  treaty: {
    summary: "Block enemy attacks and influence gain for the turn.",
    eventTemplate: "Armistice",
    contexts: ["event"],
    triggers: [],
    valueKind: "none",
    valueGuide: "Value is ignored. Optional secondary value can extend influence block.",
    needsLane: true,
  },
  revolution: {
    summary: "Gain CP and reduce the cost of your next deploy.",
    eventTemplate: "Popular Uprising",
    contexts: ["event"],
    triggers: [],
    valueKind: "number",
    valueGuide: "CP gained (typically 30–50). Deploy discount uses abilityValue2.",
  },
  trade_route: {
    summary: "Gain CP and draw one card.",
    eventTemplate: "Mercantile Exchange",
    contexts: ["event"],
    triggers: [],
    valueKind: "number",
    valueGuide: "CP gained (typically 20–40); always draws 1 card.",
  },
  reform: {
    summary: "Suppress enemy Monarch auras and lane auras until end of turn.",
    eventTemplate: "Institutional Reform",
    contexts: ["event"],
    triggers: [],
    valueKind: "none",
    valueGuide: "Value is ignored.",
    needsLane: true,
  },
  forced_hand: {
    summary: "Remove an enemy unit from the lane and put it in the opponent's hand.",
    eventTemplate: "Forced Recall",
    contexts: ["event"],
    triggers: [],
    valueKind: "none",
    valueGuide: "Value is ignored. Requires enemy unit target.",
    needsLane: true,
    needsEnemyTarget: true,
  },
  forced_discard: {
    summary: "Remove an enemy unit from the lane and send it to discard.",
    eventTemplate: "Rout the Enemy",
    contexts: ["event"],
    triggers: [],
    valueKind: "none",
    valueGuide: "Value is ignored. Requires enemy unit target.",
  ...
  exhaust_unit: {
    summary: "Exhaust an enemy unit — it cannot attack or establish influence.",
    eventTemplate: "War Weariness",
    contexts: ["event"],
    triggers: [],
    valueKind: "none",
    valueGuide: "Value is ignored. Requires enemy unit target.",
